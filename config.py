...
DEFAULT_EXTRUDE_DISTANCE_MM = 0.20

# Placement modes
PLACEMENT_STANDALONE = 'Standalone'
PLACEMENT_ON_FACE = 'Place on Face'
PLACEMENT_SVG_EXPORT = 'Export SVG Only'
PLACEMENT_MODES = [PLACEMENT_STANDALONE, PLACEMENT_ON_FACE, PLACEMENT_SVG_EXPORT]
